...
public class RobotMap { 
	...
	public static final int succCubeLeft = 8; //left
	public static final int succCubeRight = 7; //right
	
	public static final int huggerLeft = 6;
	public static final int huggerRight = 9;
